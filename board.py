...
class R(Piece):
    ...
    def display(self, al1, al2):
        self.board.add_text(25, '車', self.txt_color, al1 - 12, al2 - 12)
...
class C(Piece):
    ...
    def display(self, al1, al2):
        self.board.add_text(25, '砲', self.txt_color, al1 - 12, al2 - 12)
...
class H(Piece):
    ...
    def display(self, al1, al2):
        self.board.add_text(25, '馬', self.txt_color, al1 - 12, al2 - 12)
...
class G(Piece):
    ...
    def display(self, al1, al2):
        self.board.add_text(25, '將', self.txt_color, al1 - 12, al2 - 12)
